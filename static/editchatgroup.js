...
function filter_results_remove(){
    var checkboxes = document.getElementsByClassName("btn-check-remove");
    var labels = document.getElementsByClassName("checkbox-label-remove");
    var query = document.getElementById("username-remove").value;
